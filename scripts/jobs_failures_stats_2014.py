...
def failureJob(fileName, dirName, outputFileName, year):
	...
	with open(fileName) as f:
		...
		###########################################################################################
		if "2014" in dirName:
			data_total_jobs = [83650, 27137, 13830, 12825, 7734, 6918, 5682, 4502, 4169, 3080, 4041, 6176, 3489, 1953, 1731, 2064, 1984, 1691, 1683, 12078, 11203, 7382, 31429, 43017, 2173, 4600, 1947, 1951, 4097, 325, 335, 172, 270, 7247]
			show_bar_count = [83650, 27137, 13830, 12825, "", "", "", "", "", "", "", "", "", "", "", "", "", "", 1683, 12078, "", "", 31429, 43017, "", "", "", "", "", "", "", "", "", 7247]
		...
		plt.subplots_adjust(top=0.92, bottom=0.2, left=0.05, right=0.9, hspace=0.5, wspace=0.3)
