...
def init_tables(cabinet_2014,cabinet_2015,cabinet_2016,blade_2015,blade_2016, node_2015, node_2016, cabinet_total_count, cabinet_week, cabinet_day):
	""" Initializes tables """
...
def f_cabinets(dir_name):
	...
	init_tables(cabinet_2014,cabinet_2015,cabinet_2016,blade_2015, blade_2016, node_2015, node_2016, cabinet_total_count,cabinet_week,cabinet_day)		
	...
	print("\nPrcessing PLOT 3")		
	ax = sns.heatmap(cabinets_matrix_two_years,cmap="coolwarm", linewidths=0.1, ax = axs[1,0])
	ax.invert_yaxis()
	axs[1,0].axis("tight")
	...
	axs[1,0].set_title('2014-2015-2016')
